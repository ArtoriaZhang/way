import{_ as s,c as a,o as n,a2 as e}from"./chunks/framework.CCoplHXX.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/database/oracle/Pipelined.md","filePath":"docs/database/oracle/Pipelined.md"}'),t={name:"docs/database/oracle/Pipelined.md"},p=e(`<h2 id="typical-pipelined-example" tabindex="-1">Typical Pipelined Example <a class="header-anchor" href="#typical-pipelined-example" aria-label="Permalink to &quot;Typical Pipelined Example&quot;">​</a></h2><p>This are the typical steps to perform when using PL/SQL Table Functions:</p><ul><li><p>The producer function must use the PIPELINED keyword in its declaration.</p></li><li><p>The producer function must use an OUT parameter that is a record, corresponding to a row in the result set.</p></li><li><p>Once each output record is completed, it is sent to the consumer function through the use of the PIPE ROW keyword.</p></li><li><p>The producer function must end with a RETURN statement that does not specify any return value.</p></li><li><p>The consumer function or SQL statement then must use the TABLE keyword to treat the resulting rows from the PIPELINE function like a regular table. <strong>The first step</strong> is to define the format of the rows that are going to be returned. In this case here, we&#39;re going to return a INT, DATE followed by a VARCHAR2(25).</p></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CREATE OR REPLACE TYPE myObjectFormat </span></span>
